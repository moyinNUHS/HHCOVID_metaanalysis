...
transformed parameters {
  ...
  // Probability of infection PER DAY: allow different probabilities for each arm of each trial
  ...
  // For Simmerman 2011 (trial 2), Nicholson 2014(trial 4), Pandejpong 2012(trial 6), 
...
model { 
  ...
  // For Aiello 2012 (trial 1), Simmerman 2011(trial 2), Suess 2012(trial 5),  
  // these trials reported only one outcome per participant (binary). 
  // Hence the infection events are modeled with binomial distribution. 
  ...
  // For Simmerman 2011 (trial 2), Nicholson 2014(trial 4), Pandejpong 2012(trial 6), 
  // these trials reported multiple outcomes per participant. 
  // Hence the infection events are modeled with poisson distribution. 
